...
def get_patches(
    ...
    x_indices = x_coords.unsqueeze(-1).unsqueeze(-1) + x_grid.cuda()
    y_indices = y_coords.unsqueeze(-1).unsqueeze(-1) + y_grid.cuda()
...
class DeformableConv2d(nn.Module):
    ...
    def forward(self, x):
        ...
        max_offset = torch.tensor(max_offset, device="cuda")
